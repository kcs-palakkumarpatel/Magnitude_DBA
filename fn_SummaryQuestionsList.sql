--SELECT dbo.fn_SummaryQuestionsList('SeenClientAnswers',976927)
CREATE FUNCTION [dbo].[fn_SummaryQuestionsList]
(
...
BEGIN
        ...
        SELECT DISTINCT
            ...
            (CASE
             ...
             END
                ...
                ELSE
					dbo.fn_RemoveInvalidXMLCharacters(A.Detail)
                    --ISNULL(Detail, '')
            END + @AppndChars,
            Q.Position,
            Q.Id
    ...
    SELECT Main.shortName,
           ...
           @Table = 'Answers'
               ...
               ELSE
                   LEFT(Main.Students, CASE
                                           WHEN LEN(Main.Students) > 0 THEN
                                               LEN(Main.Students) - 1
                                           ELSE
                                               LEN(Main.Students)
                                       END) + '\n'
