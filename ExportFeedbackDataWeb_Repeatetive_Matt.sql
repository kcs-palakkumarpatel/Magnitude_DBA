...
-- =============================================  
CREATE PROCEDURE [dbo].[ExportFeedbackDataWeb_Repeatetive_Matt]
 ...
 --                       + @UserId + ''' = ''0'' OR A.UserId = 0 ';
	...
	PRINT '1' 
        ...
        SELECT Q.Position,
			   ...
			   (Select top 1 CreatedOn From CloseLoopAction where SeenClientAnswerMasterId = am.id and "Conversation" LIKE 'Resolved %' order by CreatedOn desc) as [Resolved On],
			...
			(SELECT STUFF((SELECT  ISNULL(ResolutionComments.Comments,'')  
                                            FROM    ( SELECT  ( CONVERT(VARCHAR(50), ROW_NUMBER() OVER ( ORDER BY dbo.CloseLoopAction.Id ASC ))+ ') '  
                                                      ...
                                                      FROM    dbo.CloseLoopAction  WITH(NOLOCK)  
															  ...
															  and dbo.CloseLoopAction."Conversation" NOT LIKE 'Resolved %'
