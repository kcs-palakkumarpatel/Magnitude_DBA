...
-- SP call : GetActivityListWithPendingCountByAppUserId 5124,0
-- =============================================
CREATE PROCEDURE [dbo].[GetActivityListWithPendingCountByAppUserId_palak]
    @AppUserId BIGINT,
    @IsAllocated BIT = 0
AS
BEGIN
    ...
    FROM dbo.EstablishmentGroup AS EG 
        INNER JOIN dbo.Establishment AS EST 
    ...
    BEGIN
        ...
        BEGIN
            ...
            SELECT ManagerUserId,
                   t.ActivityId
            FROM #temp2 t
                INNER JOIN dbo.AppManagerUserRights AMu 
                    ON AMu.EstablishmentId = t.Id
                       AND AMu.UserId = @AppUserId
                       AND AMu.IsDeleted = 0
                INNER JOIN dbo.AppUser au 
    ...
    BEGIN
        ...
        FROM #EstablishmentId e
            INNER JOIN #Count11 C
                ON C.ActivityId = e.ActivityId
            INNER JOIN dbo.AppManagerUserRights AMUR 
