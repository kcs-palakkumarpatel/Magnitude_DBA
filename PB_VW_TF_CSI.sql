...
FROM 
(
SELECT EstablishmentName,CapturedDate,ReferenceNo,0 AS Refno,IsPositive,Status,UserName,ISNULL(CustomerCompany,'N/A') AS CustomerCompany,CustomerEmail,CustomerMobile,CustomerName,
...
select EstablishmentName,CapturedDate,ReferenceNo,Refno,IsPositive,Status,UserName,ISNULL(CustomerCompany,'N/A') AS CustomerCompany,CustomerEmail,CustomerMobile,CustomerName,
