...
-- OLD SP NAME: WSGetActivityEstablishmetnAndEstablishmentUserByAppUserId_101120
-- Call SP: USP_WSGetActivityEstablishmetnAndEstablishmentUserByAppUserId_101120 1243,2119  
-- =============================================  

CREATE PROCEDURE USP_WSGetActivityEstablishmetnAndEstablishmentUserByAppUserId_101120  
    @AppUserId BIGINT ,  
    @ActivityId BIGINT  
AS  
BEGIN  
