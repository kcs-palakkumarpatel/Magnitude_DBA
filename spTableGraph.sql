...
-- Call SP:		spTableGraph 10450, '11601', 1941, '08 Feb 2017', 4, '1243', 0, 'Select Applicable:', ''
--				spTableGraph 10641, '11198', 1767, '28 jul 2016', 3, '422',  1, 'Confidence', ''
--				dbo.spTableGraph -2, '13503', 2491, '27 Jun 2017', 1, '1289,1338', 1, 'Growth', ''
-- =============================================
CREATE PROCEDURE [dbo].[spTableGraph]
    @QuestionId BIGINT ,
                    ...
                    BEGIN
                        ...
                        INSERT  INTO @Result
                                ...
                                FROM    dbo.View_AnswerMaster AS AM
                                        INNER JOIN dbo.Answers AS A ON AM.ReportId = A.AnswerMasterId
                                        INNER JOIN dbo.Questions AS Q ON Q.Id = A.QuestionId
                                        CROSS APPLY dbo.Split(ISNULL(A.OptionId,
                                                              ''), ',') AS O
                                        INNER JOIN ( SELECT Data
                                                     FROM   dbo.Split(@EstablishmentId,
                                                              ',')
