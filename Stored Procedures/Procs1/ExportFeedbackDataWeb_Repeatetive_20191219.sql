...
-- =============================================  
--ALTER PROCEDURE [dbo].[ExportFeedbackDataWeb_Repeatetive]
--ALTER PROCEDURE [dbo].[ExportFeedbackDataWeb_Repeatetive_20191216]
CREATE PROCEDURE [dbo].[ExportFeedbackDataWeb_Repeatetive_20191219]
(
--DECLARE 
...
--set @EstablishmentId = '0' -- varchar(max)
--set @UserId = '0' -- varchar(max)
--set @ActivityId = 1941 -- bigint
--set @Rows = 0 -- int
--set @Page = 1 -- int
--set @SmileyTypesSortby = N'' -- nvarchar(50)
--set @FromDate = '2018-12-16 06:30:48' -- datetime
--set @ToDate = '2019-12-16 06:30:48' -- datetime
--set @FilterOn = N'' -- nvarchar(50)
--set @QuestionSearch = N'' -- nvarchar(max)
--set @AppuserId = 1243 -- int
--set @ReportId = 0 -- int
--set @FormType = 'All' -- varchar(10)
