...
-- =============================================
CREATE PROCEDURE [dbo].[GetContactDetailsByReportId]
    @ReportId BIGINT
AS
 
DECLARE @ContactMasterId BIGINT
SELECT @ContactMasterId = CASE ContactMasterId WHEN 0 THEN ContactGroupId ELSE ContactMasterId end FROM dbo.SeenClientAnswerMaster WHERE id = @ReportId
