...
-- =============================================
CREATE PROCEDURE [dbo].[GetReportDataToExport_20Sept2021] @Id BIGINT, @IsOut BIT 
AS 
SET NOCOUNT ON;
    BEGIN 
        ...
        IF @IsOut = 0 
            BEGIN 
                SELECT  @cols = STUFF((SELECT 
                                       ...
                                       WHERE    Q.IsDeleted = 0 
                                                ...
                                                AND NOT EXISTS ( SELECT Id from dbo.Questions where Id = 16 OR Id = 17 OR Id = 23 ) 
          ...
          WHERE     A.IsDeleted = 0 
                   ...
                   AND A.Id IS NOT NULL 
					AND Q.IsDeleted = 0 AND  NOT EXISTS ( SELECT Id from dbo.Questions where Id = 16 OR Id = 17 OR Id = 23 )
					AND Q.IsDisplayInDetail = 1 
