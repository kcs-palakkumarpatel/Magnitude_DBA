...
-- Description:	<Description,,DeleteEstablishment>
-- Call SP    :	DeleteEstablishment
-- =============================================
    ...
    BEGIN
        ...
        WHILE @Start <= @Total 
            BEGIN
                ...
                FROM    @Tbl
                WHERE   Id = @Start
                EXEC dbo.IsReferenceExists N'Establishment', @Id,
                    @IsUsed OUTPUT
                IF @IsUsed = 0 
                    BEGIN
                        ...
                        VALUES  ( @DeletedBy ,
                                  @PageId ,
                                  'Delete record in table Establishment' ,
                                  'Establishment' ,
                                  @Id ,
                                  GETUTCDATE() ,
                                  @DeletedBy ,
                ...
                ELSE 
                    BEGIN
                        SET @Count += 1
                        SELECT  @Result = @Result + ', ' + EstablishmentName
