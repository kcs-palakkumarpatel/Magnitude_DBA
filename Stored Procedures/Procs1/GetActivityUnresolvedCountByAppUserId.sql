--GetActivityUnresolvedCountByAppUserId 1243
CREATE PROCEDURE dbo.GetActivityUnresolvedCountByAppUserId @AppUserId BIGINT
AS
BEGIN
    SET NOCOUNT ON;
