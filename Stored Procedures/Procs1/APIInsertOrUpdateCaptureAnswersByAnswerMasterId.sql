...
-- =============================================
CREATE PROCEDURE [dbo].[APIInsertOrUpdateCaptureAnswersByAnswerMasterId]
    (
...
AS
	...
	BEGIN TRY
        ...
        IF @MaxWeight > 0
            ...
            END;
IF EXISTS(SELECT 1 FROM dbo.SeenClientQuestions WHERE Id=@QuestionId AND IsDeleted=0)
BEGIN
...
BEGIN CATCH
	INSERT INTO dbo.ErrorLog
        ...
        VALUES
        (ERROR_LINE(),
         'dbo.APIInsertOrUpdateCaptureAnswersByAnswerMasterId',
         N'Database',
         ERROR_MESSAGE(),
