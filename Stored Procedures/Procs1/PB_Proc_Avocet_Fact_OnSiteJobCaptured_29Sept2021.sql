...
CREATE Procedure [dbo].[PB_Proc_Avocet_Fact_OnSiteJobCaptured_29Sept2021]
As
BEGIN
	set NoCount On;
	...
	Truncate table dbo.Avocet_Fact_OnSiteJobCaptured_Test
	...
	select EstablishmentName,CapturedDate,ReferenceNo,IsPositive,Status,UserName,[Name and Surname],
		   ...
		   ResponseLatitude,ResponseLongitude,SeenClientAnswerMasterId,Technician into Avocet_Fact_OnSiteJobCaptured_Test from [PB_VW_Avocet_Fact_OnSiteJobCaptured]
	
	Select @Desc = 'Avocet_Fact_OnSiteJobCaptured Completed.( '+  Convert(Varchar,Count(1)) + ' ) Records Inserted'  From dbo.Avocet_Fact_OnSiteJobCaptured_Test(NoLock) 
