...
-- =============================================
CREATE PROCEDURE dbo.RegisterSeenClientEscalationEmail_Original
AS
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            IF (@AnswerMasterId > 0)
            BEGIN
                SELECT @QuestionAnswers = COALESCE(@QuestionAnswers + '<br />', '') + Q.ShortName + ': ' + A.Detail
                FROM dbo.Answers AS A
            ...
            SET @EmailBody
                = REPLACE(
                             @EmailBody,
                             '[TD]',
                             dbo.MinutesToDuration(ABS(DATEDIFF(
                                                                   mi,
                                                                   CONVERT(
                                                                              DATETIME,
           ...
           BEGIN
            ...
            SET @EmailBody = REPLACE(@EmailBody, '[ComplaintDate]', dbo.ChangeDateFormat(@DateCreated, 'MM/dd/yyyy'));
