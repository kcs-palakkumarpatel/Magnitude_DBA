...
-- Call SP: GetActivityEstablishmetnAndEstablishmentUserByAppUserIdandValidateUserLogin 1243,2119
-- =============================================
/*
drop procedure GetActivityEstablishmetnAndEstablishmentUserByAppUserIdandValidateUserLogin
*/
CREATE PROCEDURE [dbo].[GetActivityEstablishmetnAndEstablishmentUserByAppUserIdandValidateUserLogin_16Sept2021]
    @ActivityId BIGINT,
    @AppUserId BIGINT,
...
BEGIN
    ...
    FROM dbo.SeenClientAnswerMaster AS SAM
        INNER JOIN dbo.Establishment AS ES
            ON ES.Id = SAM.EstablishmentId
    ...
    FROM dbo.AppUserEstablishment AS UE
        ...
        LEFT OUTER JOIN @table DC
            ON ISNULL(DC.EstablishmentId, 0) = E.Id
