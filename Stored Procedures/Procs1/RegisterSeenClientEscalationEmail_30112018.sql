...
-- Call: RegisterSeenClientEscalationEmail_30112018
-- =============================================
CREATE PROCEDURE [dbo].[RegisterSeenClientEscalationEmail_30112018]
AS
    BEGIN
...
------- For Capture -------
      ...
      --                  INNER JOIN dbo.Establishment AS E ON E.Id = Am.EstablishmentId AND (E.OutEscalationMobile IS NOT NULL
						--OR E.OutEscalationEmails IS NOT NULL) 
      --                  INNER JOIN dbo.[Group] AS G ON G.Id = E.GroupId
      --                  LEFT OUTER JOIN dbo.AppUser AS U ON Am.AppUserId = U.Id
						--						INNER JOIN dbo.AppUserEstablishment AUE ON AUE.AppUserId = Am.AppUserId AND AUE.EstablishmentId = Am.EstablishmentId
						--											AND AUE.IsDeleted = 0 AND AUE.NotificationStatus = 1
