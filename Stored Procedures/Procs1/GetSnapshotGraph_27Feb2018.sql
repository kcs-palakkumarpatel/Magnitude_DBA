...
-- =============================================
CREATE PROCEDURE dbo.GetSnapshotGraph_27Feb2018
    (
      @AppUserId BIGINT ,
      @ActivityId BIGINT ,
...
AS
    BEGIN
        ...
        IF ( @FilterOn <> '' )
            BEGIN
                INSERT  INTO @QuestionSearchTable
                        ...
                        EXEC dbo.QustionSearchForFilter @EstablishmentId,
                            @FilterOn, @IsOut;
            END;
        ELSE
            BEGIN
                                ...
                                INSERT  INTO @Result
                                        ...
                                        FROM    dbo.View_AnswerMaster AS Am
                                                ...
                                                INNER JOIN dbo.Questions Q ON A.QuestionId = Q.Id
                                                              AND Q.DisplayInGraphs = 1
                                                INNER JOIN @QuestionSearchTable QS ON ( QS.ReportId = Am.ReportId
                                                              OR QS.ReportId = 0
                                                              )
                                                INNER JOIN ( SELECT
                                                              Data
                                        ...
                                        WHERE   ActivityId = @ActivityId
                                                AND ISNULL(A.RepetitiveGroupId,
                                                           0) = 0
        ...
        SELECT  StartDate ,
                ...
                ISNULL(SUM(Score), 0.00) AS Score ,
                ...
                ISNULL(CASE @AnswerMaster
                         ...
                         ELSE 0.00
                       END, 0.00) AS BenchMarkScore ,
                ISNULL(YourScore - ( CASE @AnswerMaster
                                       WHEN 0 THEN BenchMarkScore
                                       ELSE 0
                                     END ), 0.00) AS PerformanceBenchMarkScore ,
