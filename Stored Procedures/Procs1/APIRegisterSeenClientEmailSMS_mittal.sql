...
-- Call SP:		APIRegisterSeenClientEmailSMS_mittal 603381,541939,251,27113,1243,'2mRwOIHxk1U1','',0
-- =============================================
CREATE PROCEDURE dbo.APIRegisterSeenClientEmailSMS_mittal
...
AS
    BEGIN  
        ...
        DECLARE @SendSMS BIT ,
            ...
            --END;
			--PRINT 'EmailReceiver =' @EmailReceiver
                ...
                IF @SendSMS = 1
                    ...
                    BEGIN
                        ...
                        IF @MobileNo <> ''
                            ...
                            END;                  
                    END;
					PRINT @SendEmail PRINT  @EmailText
                IF @SendEmail = 1
                    AND @EmailText <> ''
                    BEGIN	
					PRINT '2'
