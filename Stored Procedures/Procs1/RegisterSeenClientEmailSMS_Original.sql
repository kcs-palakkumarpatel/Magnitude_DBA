...
-- =============================================
CREATE PROCEDURE [dbo].[RegisterSeenClientEmailSMS_Original] @RegisterSeenClientEmailSMS XML
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    FROM dbo.AppUserEstablishment AS UE
                        ...
                        INNER JOIN dbo.AppManagerUserRights AS AM
                            ON AM.EstablishmentId = E.Id
                               AND AM.ManagerUserId = T.AppUserId --changes done by mittal
                               AND AM.UserId = @AppUserId --changes done by mittal
                    WHERE UE.IsDeleted = 0
                          AND E.IsDeleted = 0
                          AND E.Id = @EstablishmentId
                          AND UE.NotificationStatus = 1 ---- FOR User Notification trun on then Send ~/by VASU
                    ...
                    FROM dbo.AppUserEstablishment AS UE
                        ...
                        INNER JOIN dbo.AppManagerUserRights AS AM
                            ON AM.EstablishmentId = E.Id
                               AND AM.ManagerUserId = UE.AppUserId --changes done by mittal
                               AND AM.UserId = @AppUserId -- changes done by mittal
                    WHERE UE.IsDeleted = 0
                          AND E.IsDeleted = 0
                          AND U.IsAreaManager = 1
