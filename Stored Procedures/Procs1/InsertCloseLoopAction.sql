...
-- =============================================  
CREATE PROCEDURE [dbo].[InsertCloseLoopAction]
    @AppUserId BIGINT,
...
BEGIN CATCH
	INSERT INTO dbo.ErrorLog
        ...
        (ERROR_LINE(),
         ...
         GETUTCDATE(),
         ISNULL(@AppUserId,0),
         @AppUserId+','+@Conversation+','+@ReportId+','+@IsOut+','+@ReminderDate+','+@Attachment+','+@lgCustomerUserId+','+@CustomerName,
         GETUTCDATE(),
         ISNULL(@AppUserId,0)
        );
END CATCH
