...
-- =============================================  
CREATE PROCEDURE dbo.ExportFeedbackDataWeb_Repeatetive_Original
(
    ...
    BEGIN
        ...
        SELECT Q.Position,
               ...
               CASE Q.SeenClientQuestionIdRef
                   WHEN NULL THEN
                       CQ.ShortName
                   --('('+ ANS.RepetitiveGroupName  + CAST( ANS.RepeatCount AS VARCHAR(20))+')' + CQ.ShortName)
                   ELSE
                       --Q.ShortName
