...
-- Call SP:  InsertCloseLoopActionV2 1243,'vasudev (Vasudev@magnitude4u.com) test123',87272,1,'','','','155127$EU5B4psKTd41','COxuOTr8QDE1'
-- Call SP:  InsertCloseLoopActionV2 1243,'@Anant Bhatt testt notification',87271,1,'','','','18438$EU5B4psKTd41','nnHvHoa9vc41'   
-- =============================================        
CREATE PROCEDURE dbo.InsertCloseLoopActionV2_BP
    @AppUserId BIGINT,
...
BEGIN
	...
	PRINT 123
        ...
        SET @Message
            = 'Reminder ' + CHAR(13) + CHAR(10) + 'Activity: ' + @EstablishmentName + '; User: ' + @UserName
              + '; Action: ' +
              (
        ...
        BEGIN
            ...
            --Start @Me With Other User Reminder Notification
            PRINT 1;
            INSERT INTO dbo.PendingNotification
            (
                ModuleId,
    ...
    BEGIN
        ...
        --IF (ISNULL(@meUserId, 0) = 0)
        --BEGIN
        --    IF EXISTS (SELECT 1 FROM @AlertUserIdTable)
        --    BEGIN
        --        INSERT INTO dbo.PendingNotification
        --        (
        --            ModuleId,
