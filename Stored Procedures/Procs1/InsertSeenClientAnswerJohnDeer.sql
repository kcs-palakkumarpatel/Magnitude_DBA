...
-- =============================================
CREATE PROCEDURE [dbo].[InsertSeenClientAnswerJohnDeer]
(
...
BEGIN CATCH
	INSERT INTO dbo.ErrorLog
        ...
        VALUES
        (ERROR_LINE(),
         'dbo.InsertSeenClientAnswerJohnDeer',
         N'DATABASE',
         ERROR_MESSAGE(),
         ...
         GETUTCDATE(),
         ISNULL(@AppUserId,0),
         @lgAnswerMasterId+','+@lgToEstablishmentId+','+@workflowMasterID+','+@AppUserIds+','+@FromRefernceId,
         GETUTCDATE(),
         ISNULL(@AppUserId,0)
        );
END CATCH
