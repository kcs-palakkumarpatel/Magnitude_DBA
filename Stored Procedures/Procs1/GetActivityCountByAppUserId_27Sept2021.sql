/*
Exec GetActivityCountByAppUserId 5895

GetAppUserForTaskAllocationByActivity 7949, 18268
Drop Procedure GetActivityCountByAppUserId 18268
*/
CREATE PROCEDURE [dbo].[GetActivityCountByAppUserId_27Sept2021] @AppUserId BIGINT
AS
BEGIN
    SET NOCOUNT ON;
    ...
    --          --UT.ActivityId
    --   FROM dbo.View_AllAnswerMaster_1 AS A
    --INNER JOIN #UserId ON (#UserId.userid = A.UserId
    --                  OR #UserId.userid = A.TransferFromUserId)
    ...
    FROM dbo.AnswerMaster AS Am
        ...
        --LEFT OUTER JOIN dbo.AppUser AS TransferFromUser  ON AM.AppUserId = TransferFromUser.Id  
        INNER JOIN #UserId
            ON (#UserId.userid = Am.AppUserId) --OR #UserId.userid = TransferFromUser.Id)
    ...
    --select * from #temp Order by SeenClientAnswerMasterId
    --where ActivityId = 3697
    ...
    (
        ...
        FROM dbo.ContactDetails AS c
            ...
            INNER JOIN ContactGroupRelation CGR
                ON CGR.ContactMasterId = c.ContactMasterId
                   AND CGR.ContactGroupId = A.ContactGroupId
                   AND CGR.IsDeleted = 0
               ...
               SELECT
                   (
                       ...
                       WHERE PNW.AppUserId = @AppUserId
                             ...
                             AND PNW.IsDeleted = 0
                             AND SA.IsDeleted = 0
                             AND Exists ( select ModuleId from PendingNotificationWeb where ModuleId = 8 OR ModuleId = 12 )
							 AND
                             (
                                 A.IsAreaManager = 1
                   ...
                   (
                       ...
                       WHERE PNW.AppUserId = @AppUserId
                             ...
                             AND PNW.IsDeleted = 0
                             AND AM.IsDeleted = 0
                             AND Exists ( select ModuleId from PendingNotificationWeb where ModuleId = 7 OR ModuleId = 11 )
                             AND
                             (
                                 AM.AppUserId = 0
