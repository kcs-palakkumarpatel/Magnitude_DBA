...
-- Call SP    :		GetSeenClientQuestionsBySeenClientId 3
-- =============================================
CREATE PROCEDURE [dbo].[GetCaptureQuestionsWithoutRepetitive] @SeenClientId BIGINT
AS
    BEGIN
