...
-- Call SP:		dbo.GetPendingNotificationWebListByUserId_06122017 933,429
--				dbo.GetPendingNotificationWebListByUserId 933,429
-- =============================================
CREATE PROCEDURE dbo.GetPendingNotificationWebListByUserId_06122017
    @AppUserId BIGINT ,
    @ActivityId BIGINT
AS
    BEGIN
