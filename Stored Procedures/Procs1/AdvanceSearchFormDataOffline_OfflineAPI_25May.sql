...
/*
EXEC dbo.AdvanceSearchFormDataOffline_OfflineAPI_25May @EstablishmentId = '0',
...
Drop procedure [dbo].[AdvanceSearchFormDataOffline_OfflineAPI_25May]
*/
--=============================================
CREATE PROCEDURE [dbo].[AdvanceSearchFormDataOffline_OfflineAPI_25May]
...
BEGIN
	...
	WHERE id = @AppuserId AND GroupId IN (SELECT data FROM dbo.Split((SELECT KeyValue FROM dbo.AAAAConfigSettings WHERE KeyName = 'ExcludeGroupId'),','));
