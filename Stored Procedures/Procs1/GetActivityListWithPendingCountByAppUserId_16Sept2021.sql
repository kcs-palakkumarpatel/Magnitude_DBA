...
-- =============================================
CREATE PROCEDURE [dbo].[GetActivityListWithPendingCountByAppUserId_16Sept2021]
    @AppUserId BIGINT ,
    @IsAllocated BIT = 0
AS
BEGIN
    ...
    BEGIN
        ...
        ORDER BY UT.DisplaySequence,UT.ActivityName ASC;
    END;
    ELSE
    BEGIN
        SELECT UT.ActivityId,
               ...
               ISNULL(QuestionnaireType, '') AS QuestionnaireType
        FROM #UserTable AS UT
        ORDER BY UT.DisplaySequence, UT.ActivityName;
    END;
