...
CREATE Procedure [dbo].[PB_Proc_Nosa_Fact_Covid]
As
BEGIN
	set NoCount On;
	...
	Truncate table dbo.Nosa_Fact_Covid
...
[Loss Taste/Smell],[underlying medical],[What is condition]
	...
	Select @Desc = 'Nosa_Fact_Covid Completed.( '+  Convert(Varchar,Count(1)) + ' ) Records Inserted'  From dbo.Nosa_Fact_Covid(NoLock) 
