...
-- Call SP:	GetFormDetailByReferenceId 1608916,0
-- =============================================
CREATE PROCEDURE [dbo].[GetFormDetailByReferenceId]
    @ReportId BIGINT,
    @IsOut BIT
AS
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            SELECT Q.Position,
                   ...
                   Q.SectionNo,
                   Q.SectionName,
				   ISNULL(A.SectionPI,0) AS SectionPI
                ...
                SELECT Q.Id,
                       ...
                       CASE Q.QuestionTypeId
                           ...
                           WHEN 23 THEN
                               Q.ImagePath
                           WHEN 17 THEN
                               dbo.GetRefernceQuestionImagePath(Detail, 1, Q.Id)
                           ELSE
                               ISNULL(A.Detail, '')
                       END AS Detail,
                       CASE Q.QuestionTypeId
    ...
    BEGIN CATCH
        ...
        VALUES
        (ERROR_LINE(),
         'dbo.GetFormDetailByReferenceId',
         N'DATABASE',
         ERROR_MESSAGE(),
