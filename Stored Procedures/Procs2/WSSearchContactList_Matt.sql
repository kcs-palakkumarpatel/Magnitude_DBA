...
-- Call: dbo.WSSearchContactList_Matt 201,1,'',1,50,0,4516
-- =============================================
CREATE PROCEDURE [dbo].[WSSearchContactList_Matt]
    @GroupId BIGINT,
    @WithGroup BIT,
    @Search NVARCHAR(100),
    @Page INT,
...
BEGIN
    ...
    BEGIN
		...
		ORDER BY CQ.Position ASC
			...
			on CM.Id = C.ContactMasterId And CM.ContactId = C.ContactId
