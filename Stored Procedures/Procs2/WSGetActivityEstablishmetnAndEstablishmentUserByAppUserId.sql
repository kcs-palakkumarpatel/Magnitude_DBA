...
-- Call SP: WSGetActivityEstablishmetnAndEstablishmentUserByAppUserId 18336,5503
-- =============================================
/*
drop procedure WSGetActivityEstablishmetnAndEstablishmentUserByAppUserId_101120 18336,5503
*/
CREATE PROCEDURE [dbo].[WSGetActivityEstablishmetnAndEstablishmentUserByAppUserId]
    @AppUserId BIGINT ,
    @ActivityId BIGINT
AS
BEGIN
SET DEADLOCK_PRIORITY NORMAL;
    ...
    SELECT  E.Id AS EstablishmentId ,
		...
		ISNULL(E.InitiatorAsRespondent,0) AS IsInitiatorAsRespondent
...
BEGIN CATCH
	INSERT INTO dbo.ErrorLog
        ...
        VALUES
        (ERROR_LINE(),
         'dbo.WSGetActivityEstablishmetnAndEstablishmentUserByAppUserId',
         N'DATABASE',
         ERROR_MESSAGE(),
