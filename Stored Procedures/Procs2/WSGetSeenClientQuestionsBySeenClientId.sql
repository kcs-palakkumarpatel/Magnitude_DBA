...
-- =============================================
CREATE PROCEDURE dbo.WSGetSeenClientQuestionsBySeenClientId
    @SeenClientId BIGINT,
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT Q.Id AS QuestionId,
               ...
               ISNULL(Q.IsSection, 0) AS IsSection,
               ISNULL(Q.SectionNo, 0) AS SectionNo,
               ISNULL(Q.SectionName, '') AS SectionName
    ...
    BEGIN CATCH
        ...
        (ERROR_LINE(),
         ...
         @SeenClientId + ',' + @ContactMasterId + ',' + @IsContactGroup + ',' + @ContactMasterIdList,
         GETUTCDATE(),
         N''
        );
    END CATCH;
