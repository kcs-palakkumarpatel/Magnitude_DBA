...
--	Description:	
--	Call SP:	dbo.WSGetAppUserActivityByAppUserId 1544, ''
--	=============================================
CREATE PROCEDURE dbo.WSGetAppUserActivityByAppUserId_17102018
    @AppUserId BIGINT ,
    ...
    BEGIN
        ...
        WHERE   KeyName = 'EstablishmentCountByActivityId';
                ...
                FROM  (SELECT DISTINCT
                                    ...
                                    CASE WHEN (SELECT  COUNT(1) FROM dbo.Establishment 
													INNER JOIN dbo.AppUserEstablishment AUE ON AUE.EstablishmentId = Establishment.Id 
													WHERE EstablishmentGroupId = EG.Id AND AUE.AppUserId = @AppUserId
                                    ...
                                    ( SELECT    dbo.IsTellUsSubmitted(@AppUserId,
                                                              EG.Id)
