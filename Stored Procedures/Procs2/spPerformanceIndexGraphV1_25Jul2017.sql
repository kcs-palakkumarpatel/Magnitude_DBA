...
-- Call SP:		spPerformanceIndexGraphV1 '11601', 1941, '09 May 2017', 4, -1, '390,422,449,450,451,464,467,468,471,472,633,880,976,977,995,1156,1240,1243,1245,1246,1247,1248,1249,1311', 1, '',1243
-- =============================================
CREATE PROCEDURE dbo.spPerformanceIndexGraphV1_25Jul2017
                            ...
                            BEGIN
							 ...
							 FROM (
							    SELECT CASE @Type
                                        ...
                                        END AS CreatedOn ,
                                        --SUM(QPI) AS Detail ,
                                        ( SUM(Weight) * 100 ) / SUM(MaxWeight) AS Detail ,
                                        COUNT(DISTINCT AM.Id) AS Total ,
                                        0 BenchmarkScore ,
                                        0 BenchmarkCounts,
										AM.Id FROM (
                                        SELECT     AM.CreatedOn , AVG(A.Weight) AS Weight ,
                                                    AM.ReportId AS Id ,
                                                    CASE AVG(A.Weight)
                                                      WHEN 0 THEN 0
                                                      ELSE Q.MaxWeight
