...
-- Call SP    :	SearchDraftedFormsDataWeb_101120 5093,5193,'','2020-10-12 14:28:15','2020-10-13 14:28:17'
-- =============================================
/*
drop procedure SearchDraftedFormsDataWeb_101120
*/
CREATE PROCEDURE dbo.SearchDraftedFormsDataWeb_101120
	@AppuserId BIGINT = 0 ,
...
SET NOCOUNT ON;
	SELECT  ISNULL(SAM.Id, 0) AS Id,
        ...
        dbo.ChangeDateFormat(DATEADD(MINUTE, ES.TimeOffSet, SAM.CreatedOn),'dd/MMM/yyyy hh:mm AM/PM') AS CaptureDate ,
	...
	AND (ES.EstablishmentName LIKE '%' + @Search + '%'
			...
			OR dbo.ChangeDateFormat(DATEADD(MINUTE, ES.TimeOffSet, SAM.CreatedOn),'dd/MMM/yyyy hh:mm AM/PM') LIKE '%' + @Search + '%'
