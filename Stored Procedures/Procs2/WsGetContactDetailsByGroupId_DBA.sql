-- EXEC WsGetContactDetailsByGroupId_DBA 70,966

CREATE PROCEDURE dbo.WsGetContactDetailsByGroupId_DBA
    @GroupId BIGINT ,  
    @AppUserId BIGINT  
AS  
    BEGIN  
            ...
            BEGIN  
                INSERT  INTO @SeenclinetContact  
                        ...
                        FROM    ( SELECT TOP 50  
                                  ...
                                  FROM   
								  (
										SELECT SAM.ContactMasterId, SAM.ContactGroupId,
										SAM.IsSubmittedForGroup,
										SAM.SeenClientId,
										SAM.CreatedOn AS CreatedOn,
										SAM.EstablishmentId
										FROM SeenClientAnswerMaster SAM
										WHERE SAM.CreatedOn  BETWEEN GETDATE()-7 AND GETDATE()
								   ) SAM  
