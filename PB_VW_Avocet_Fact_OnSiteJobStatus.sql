Create view PB_VW_Avocet_Fact_OnSiteJobStatus as
...
Where (G.Id=469 and EG.Id IN(4089)
...
inner join EstablishmentGroup EG on G.id=EG.groupid
inner join Establishment E on  E.EstablishmentGroupId=EG.Id 
inner join SeenClientAnswerMaster AM on AM.EstablishmentId=E.id Where (G.Id=469 and EG.Id IN(4089)
ANd (AM.IsDeleted=0 or AM.IsDeleted=null)))A on A.id=Sh.referenceno
