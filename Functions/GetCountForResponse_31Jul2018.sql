...
-- Call:		select dbo.GetCountForResponse(1243,2433)
-- =============================================
CREATE FUNCTION [dbo].[GetCountForResponse_31Jul2018]
    (
	@AppUserId BIGINT,
	@ActivityId BIGINT
	)
                      ...
                      FROM      dbo.View_AllAnswerMaster AS A
                                ...
                                INNER JOIN ( SELECT *
                                             FROM   dbo.Split(@UserId, ',')
                                                       ...
                                                       OR U.Data = ISNULL(A.TransferFromUserId,
                                                              0)
                                                       OR @UserId = '0'
                                                       OR A.UserId = 0
                                                     )
