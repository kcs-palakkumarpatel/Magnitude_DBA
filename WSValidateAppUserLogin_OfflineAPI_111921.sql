...
--	=============================================
/*
drop procedure WSValidateAppUserLogin_OfflineAPI

Exec WSValidateAppUserLogin_OfflineAPI 'vasudevp', '67cfE4x5Ra18G7LA1pRAXA=='
*/
CREATE PROCEDURE [dbo].[WSValidateAppUserLogin_OfflineAPI_111921]
