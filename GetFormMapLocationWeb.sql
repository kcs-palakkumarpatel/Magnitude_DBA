...
-- Create date:	
-- Description:	
-- Call SP:	dbo.GetFormMapLocationWeb
-- =============================================
CREATE PROCEDURE [dbo].[GetFormMapLocationWeb]
...
DECLARE @ActivityType NVARCHAR(50);
     ...
     SELECT  * FROM    @Result WHERE CAST(Latitude AS DECIMAL(18,0)) != 0 AND CAST(Longitude AS DECIMAL(18,0)) != 0;
    END;
