...
-- =============================================
CREATE PROCEDURE [dbo].[InsertSeenClientAnswerMasterByExport]
(
...
BEGIN
 SET NOCOUNT ON; 
    ...
    BEGIN TRY
		...
		DECLARE @MinGroupID INT = 0 ;
		SELECT @MinGroupID = MIN(GroupID)
        ...
        BEGIN
            ...
            FROM @ImportTaskTypeTableType
            WHERE GroupID = @MinGroupID + @Counter - 1;
            ...
            BEGIN
                ...
                FROM dbo.SeenClientOptions SCO WITH(NOLOCK)
                ...
                SELECT @SeenClientAnswerMasterID,
                       ...
                       (
                           ...
                           FROM dbo.SeenClientOptions t WITH(NOLOCK)
