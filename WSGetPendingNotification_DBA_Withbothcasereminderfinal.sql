...
-- =============================================
CREATE PROCEDURE [dbo].[WSGetPendingNotification_DBA_Withbothcasereminderfinal]
...
SELECT *,ROW_NUMBER() OVER (PARTITION BY Id,CAST(NotificationDate AS DATE) ORDER BY CreateDate DESC) RNum FROM (			
	   ...
	   THEN eg.EstablishmentGroupType
	   ELSE egg.EstablishmentGroupType
	   END  IS NOT NULL  and E.IsDeleted = 0' + @UserFilterCondition + CHAR(13) + @FilterDate + CHAR(13)
+ @FilterTextSearch
+ @FilterUser + ' 
