...
/*
EXEC dbo.AdvanceSearchFormDataOffline_101120 @EstablishmentId = '0',
...
EXEC dbo.AdvanceSearchFormDataOffline @EstablishmentId = '0',
@UserId = '0', -- varchar(max)
@ActivityId = 2101, -- bigint
@FromDate = '2019-11-11 00:00:00', -- datetime
@ToDate = '2020-11-10 23:59:59', -- datetime
...
Drop procedure [dbo].[AdvanceSearchFormDataOffline_101120]
*/
--=============================================
CREATE PROCEDURE [dbo].[AdvanceSearchFormDataOffline_101120]
...
BEGIN
	...
	SET @SqlSelect11 =  CHAR(13) + N'FROM    ( SELECT    A.* ,
                                   ...
                                   ( SELECT CASE A.IsOut WHEN 1 THEN ISNULL(( SELECT CASE WHEN IsRecursion = 0 THEN 0 ELSE 1 END FROM dbo.SeenClientAnswerMaster WHERE   Id = A.ReportId ), 0) ELSE 0 END ) AS IsRecursion,
									...
									FROM  dbo.View_AllAnswerMaster_101120 AS A ';
	...
	EXEC ('select A.SeenClientAnswerMasterId FROM  dbo.View_AllAnswerMaster_101120 AS A ' + @SqlSelect12 + @SqlSelect2 + @Filter + ' Group By A.SeenClientAnswerMasterId');
