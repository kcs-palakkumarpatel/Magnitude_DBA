...
-- Modified by : Nimesh Pancholi
-- Call SP:RegisterSeenClientEmailSMS '<ClsAnswers><row><lgAnswerMasterId>363130</lgAnswerMasterId><SeenClientAnswerChildId></SeenClientAnswerChildId><lgSeenClientId>609</lgSeenClientId>  <lgEstablishmentId>11601</lgEstablishmentId><lgAppUserId>1243</lgAp
--pUserId><EncryptedId>HMZJ--L88Bk1</EncryptedId><lstReoccurring></lstReoccurring><Resend>false</Resend></row></ClsAnswers>'  
-- =============================================  
CREATE PROCEDURE [dbo].[UDSP_NP_RegisterSeenClientEmailSMS] @RegisterSeenClientEmailSMS XML  
...
BEGIN  
	...
	DROP INDEX IF EXISTS IDX_TEMPTABLE ON #TempTable;
	CREATE CLUSTERED COLUMNSTORE INDEX IDX_TEMPTABLE ON #TempTable;
