...
Call:			WSGetContactFormByGroupId 10008,'2016-01-01 04:32:07.647'
				WSGetContactFormByGroupId 20010,null
=============================================
*/

CREATE PROCEDURE [dbo].[WSGetContactFormByGroupId]
	@GroupId BIGINT,
...
BEGIN
    ...
    SELECT DISTINCT CQ.Id AS QuestionId,CQ.QuestionTypeId,QuestionTitle,ShortName,[Required],[MaxLength],ISNULL(Hint,'') AS Hint,
	ISNULL(OptionsDisplayType,'') AS OptionsDisplayType,IsTitleBold,IsTitleItalic,IsTitleUnderline,TitleTextColor,Position,IsGroupField,
	ISNULL(D.ContactOptionId,'') AS ContactOptionId,ISNULL(D.Detail,'') AS Detail,Margin,FontSize,ISNULL(@Url + CQ.ImagePath,'') AS ImagePath,
	CQ.IsDisplayInDetail AS DisplayInDetail,CQ.IsDisplayInSummary AS DisplayInList,CQ.IsCommentCompulsory AS IsCommentCompulsory
