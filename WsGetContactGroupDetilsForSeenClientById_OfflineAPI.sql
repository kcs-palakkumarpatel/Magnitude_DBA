/*
EXEC dbo.WsGetContactGroupDetilsForSeenClientById_OfflineAPI 8243,1827,1

Drop procedure WsGetContactGroupDetilsForSeenClientById_OfflineAPI
*/

CREATE PROCEDURE [dbo].[WsGetContactGroupDetilsForSeenClientById_OfflineAPI]
