...
CREATE view [dbo].[PB_VW_Masslift_Fact_ClientUtilization] as
...
dbo.[Group] G 
INNER JOIN dbo.EstablishmentGroup EG ON G.Id=eg.GroupId AND G.Id =463 and establishmentgrouptype='Sales'
inner join Establishment E on  E.EstablishmentGroupId=EG.Id
INNER JOIN SeenClientAnswerMaster AM on AM.EstablishmentId=E.Id
INNER JOIN dbo.AppUser U ON U.Id=AM.AppUserId and U.id<>3973
...
inner join Establishment E on  E.EstablishmentGroupId=EG.Id
inner join SeenClientAnswerMaster AM on AM.EstablishmentId=E.id
inner join Appuser U on U.id=AM.Appuserid and U.id<>3973 Where (G.Id=463  and establishmentgrouptype='Sales'
