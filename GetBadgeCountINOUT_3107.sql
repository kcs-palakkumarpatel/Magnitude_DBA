...
-- Call:		select dbo.GetBadgeCountINOUT(1615,2517,30,1)
-- =============================================
CREATE FUNCTION dbo.GetBadgeCountINOUT_3107
(
   @AppuserId INT ,
	@ActivityId INT ,
	@Days INT ,
...
SET @UserId = (SELECT dbo.AllUserSelected_3107(@AppuserId,0,@ActivityId))
DECLARE @Result INT
    IF ( @Type = 0 )
        BEGIN
