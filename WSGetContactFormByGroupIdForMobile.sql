...
Description:	Get ContactFrom by UserGroupId for Mobile
Call:			WSGetContactFormByGroupId 10008,'2016-01-01 04:32:07.647'
				WSGetContactFormByGroupId 696,'2020-11-03 09:08:01.087'
=============================================
*/

CREATE PROCEDURE [dbo].[WSGetContactFormByGroupIdForMobile]
    @GroupId BIGINT,
