create view PB_VW_AA_Fact_ExistingExternal
as
with cte as(
...
inner join Questions Q on Q.id=A.QuestionId AND q.Id IN (27298,65392,64539,32587,27790)
...
)y on x.ReferenceNo=y.SeenClientAnswerMasterId and upper(x.[Name of Learner])=upper(y.[Student Name]) --where referenceno=1196463
--order by 2 desc
