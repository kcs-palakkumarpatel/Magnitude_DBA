...
create view PB_VW_SOG_Fact_TrainingTracker as
...
Where (G.Id=487 and EG.Id =5293 --and u.id not in (3722,3973)
ANd (AM.IsDeleted=0 or AM.IsDeleted=null)) and (AM.IsDisabled=0 or AM.IsDisabled is null)
and Q.id in(42594,42595,42596,42597,42598,42599,42600,42601,42602)
