...
-- Description:	<Description,,GetQuestionByCaptureId>
-- Call SP    :	GetQuestionByCaptureId 1828
-- =============================================
CREATE PROCEDURE [dbo].[GetQuestionByCaptureId]
   @CaptureId BIGINT
AS
    BEGIN
