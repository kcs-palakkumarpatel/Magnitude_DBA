...
CREATE FUNCTION dbo.GetAdditionalFeedBackAutoSMSEmailText (@AnswerMasterId BIGINT)
...
BEGIN
    ...
    SELECT @EstablishmentName = EstablishmentName,
           ...
           @EmailSubject = E.AdditionalFeedbackEmailSubject,
           @EmailText = E.AdditionalFeedbackEmailBody,
           @SMSText = E.AdditionalFeedbackSMSBody,
           @EI = Am.EI,
