...
-- Call SP:		spAnalysisGraphV1 11831,'11601', 1941, '09 May 2017', 4, 8952, '390,422,449,450,451,464,467,468,471,472,633,880,976,977,995,1156,1240,1243,1245,1246,1247,1248,1249,1311', 1,'',1243
-- =============================================
CREATE PROCEDURE dbo.spAnalysisGraphV1_25jul2017
    @QuestionId BIGINT ,
                    ...
                    BEGIN
                        ...
                        INSERT  INTO @Result
                                ...
                                SELECT  CASE @Type
                                          ...
                                          ELSE DATEPART(MONTH, CreatedOn)
                                        END ,
                                        SUM(CAST(ISNULL(Detail, 0) AS BIGINT)) AS Detail,
                                        --COUNT(DISTINCT AM.Id) AS Total,
										SUM([Counts]) AS Total,
                                        0,
                                        0,
